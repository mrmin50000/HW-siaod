...
- == а) Реализуйте задачу сортировки числового файла с заданными условиями. Добавьте в код возможность определения времени работы программы.
```cpp
#include <iostream>
#include <vector>
#include <fstream>
...
#pagebreak()
Вывод программы:
#image("Screenshot_20250908_104826.png")
- == б) Определите программно объём оперативной памяти, занимаемый битовым массивом.
```cpp 
#include <iostream>
#include <vector>
#include <fstream>
...
```
Вывод программы:
#image("Screenshot_20250908_113933.png")
#pagebreak()
= Вывод из работы
Я освоил приёмы работы с битовым представлением беззнаковых
целых чисел, реализовал эффективный алгоритм внешней сортировки на основе
битового массива.